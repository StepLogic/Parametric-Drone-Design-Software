...
from Utils.database.aerodynamics.settings_database import set_mach_number, set_aoa_range, set_altitude, \
    read_settings
...
class aerodynamic_settings_tab(QWidget):
    ...
    def show_default_values(self, altitude_=0, aoa_range_=None, mach_number_=None):

        if mach_number_ is None:
            mach_number_ = 0
