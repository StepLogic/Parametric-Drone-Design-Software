...
class v_stab_tab(QDialog):
    def __init__(self,text, surface_type_, design_type_):
        ...
        self.Wing_postion_tlabel = QLabel("Fin Leading Edge Position")
        ...
        self.vtp_position_z_text = QLineEdit()
        layout.addRow(self.Wing_postion_z_label, self.vtp_position_z_text)
        ...
        self.parameters = {
            lifting_surface: {
                str(self.text): {
                    ...
                    root_le_position_z: float(self.vtp_position_z_text.text()),
