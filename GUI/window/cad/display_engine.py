...
class display_engine(_viewer_):
    ...
    def export_files_for_simulation(self,control_surface={},body={}):
        ...
        for part, loft in body.items():
            ...
            try:
                for l in loft:
                     stl_writer.Write(l, model_dir + "/body/" + part+".stl")
                     os.system(f"meshio-convert {model_dir}/body/{part}.stl   {model_dir}/body/{part}.obj")
            except:
                stl_writer.Write(loft, model_dir + "/moveables/" + part + ".stl")
                os.system(f"meshio-convert {model_dir}/moveables/{part}.stl   {model_dir}/moveables/{part}.obj")
