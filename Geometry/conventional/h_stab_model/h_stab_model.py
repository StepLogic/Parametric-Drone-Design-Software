...
class h_stab_model():
    ...
    def get_current_loft(self):
        ...
        n = random.random()
        self.h_stab = self.wings.create_wing(f"h_stab{n}", 3, "NACA{}".format(self.airfoil_type))
        self.h_stab.set_symmetry(tigl3.geometry.TIGL_X_Z_PLANE)
        self.iter += 1

        self.h_stab.set_root_leposition(tigl3.geometry.CTiglPoint(self.root_location_x
