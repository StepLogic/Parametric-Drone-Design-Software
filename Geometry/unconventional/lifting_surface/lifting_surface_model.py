...
class lifting_surface_model:
    ...
    def get_lower_surface(self):
        self.read_parameters()
        uid_mgr = self.aircraft.get_uidmanager()
        self.lifting_surface = uid_mgr.get_geometric_component("Wing")
        ...
        loft = []
        loft.append(self.lifting_surface.get_lower_shape())
        loft.append(rib1.get_loft().shape())
