...
from utils.Database import read_aerodynamic_results, read_control_specifications
...
class PlotterModule():
    ...
    def plot_cl_against_alpha(self):
        self.plot2d(
            ...
            y_name=self.cl_alpha, y_label='CL')
    ...
    def plot_cm_against_alpha(self):
        self.plot2d(title="plot_cm_against_alpha", x_name=self.r_x, y_name=self.cm_alpha, y_label="Cm", x_label="Alpha")
